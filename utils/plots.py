...
def plot_one_box(x, im, color=None, label=None, line_thickness=3):
    ...
    if label:
        ...
        cv2.rectangle(im, (c1[0], c1[1]), (c2[0]-50, c2[1]+10),  color, -1, cv2.LINE_AA)  # filled
        cv2.putText(im, label, (c1[0], c1[1] - 2), 1, tl / 3, [225, 255, 255], thickness=1, lineType=cv2.LINE_AA)
